...
import { Calendar, User, AlertCircle, GripVertical, Paperclip, MessageSquare, History } from "lucide-react";
...
export const TaskCard = ({ task, onStatusChange, onEdit, onDelete, isDragging }: TaskCardProps) => {
    ...
    >
      <div className="flex items-start justify-between mb-2">
        <div className="flex items-start gap-2 flex-1">
          ...
          <h4 className="font-medium text-slate-900 group-hover:text-blue-600 transition-colors flex-1">
            {task.title}
          </h4>
        </div>
